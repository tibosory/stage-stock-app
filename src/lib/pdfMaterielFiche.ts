...
export async function buildMaterielFichePageHtml(
  ...
  const rows: [string, string][] = [
    ...
    ['Dernière maintenance', fmtDateFr(mat.prochain_controle)],
    [
      'Fréquence maintenance (j.)',
      mat.intervalle_controle_jours != null ? val(String(mat.intervalle_controle_jours)) : '—',
    ],
    ['Maintenance à effectuer', val(mat.maintenance_todo)],
    ['Commentaire dernière maintenance', val(mat.maintenance_last_comment)],
